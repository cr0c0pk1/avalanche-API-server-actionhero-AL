import * as cChainMethods from "../../src/modules/c-chain";
import * as xChainMethods from "../../src/modules/x-chain";
import * as pChainMethods from "../../src/modules/p-chain";
...
describe("GET /api/network", () => {
  it("should satisfy OpenAPI spec", async () => {
    const res = await axios.get("http://localhost:4444/api/network");
...
describe("GET /api/address/hash/{hash}", () => {
  it("should satisfy OpenAPI spec", async () => {
    ...
    const res = await axios.get(
      `http://localhost:4444/api/address/hash/${hash}`
    );
...
describe("GET /api/blocks/hash/{hash}", () => {
  it("should satisfy OpenAPI spec", async () => {
    ...
    const res = await axios.get(
      `http://localhost:4444/api/blocks/hash/${hash}`
    );
...
describe("GET /api/blocks/number/{blockNumber}", () => {
  it("should satisfy OpenAPI spec", async () => {
    ...
    const res = await axios.get(
      `http://localhost:4444/api/blocks/number/${blockNumber}`
    );
...
describe("GET /api/transactions/hash/{hash}", () => {
  it("should satisfy OpenAPI spec", async () => {
    ...
    const res = await axios.get(
      `http://localhost:4444/api/transactions/hash/${hash}`
    );
...
describe("GET /api/transactions/{address}/{n}/{x}", () => {
  it("should satisfy OpenAPI spec", async () => {
    ...
    const x = 5;
    const res = await axios.get(
      `http://localhost:4444/api/transactions/${address}/${n}/${x}`
    );
...
describe("GET /api/transactions/{n}/{x}", () => {
  it("should satisfy OpenAPI spec", async () => {
    ...
    const x = 5;
    const res = await axios.get(
      `http://localhost:4444/api/transactions/${n}/${x}`
    );
...
describe("GET /api/transactions/recentxchain", () => {
  it("should satisfy OpenAPI spec", async () => {
    const res = await axios.get(
      `http://localhost:4444/api/transactions/recentxchain`
    );
...
describe("GET /api/transactions/recentpchain", () => {
  it("should satisfy OpenAPI spec", async () => {
    const res = await axios.get(
      `http://localhost:4444/api/transactions/recentpchain`
    );
...
describe("C-chain", () => {
  it("test get Block By Hash without starting client", async () => {
    const result = await cChainMethods.getBlockByHashFromCChain(
      "0x112312312312"
    );
  ...
  it("test get Transaction By Hash on running client", async () => {
    const result = await cChainMethods.getTransactionByHashFromCChain(
      "0xad3e63d2ce666830fed2a64e76d2a593cbff67fcc07a9ef650b6bc2975f61cb2"
    );
    expect(result[1].result.hash).toBe(
      "0xad3e63d2ce666830fed2a64e76d2a593cbff67fcc07a9ef650b6bc2975f61cb2"
    );
  });
  ...
  it("test get Transaction By Hash on running client (Wrong Input)", async () => {
    ...
    expect(result[1].error.message).toBe(
  ...
  it("test get Address Info on running client", async () => {
    const result = await cChainMethods.getAddressInfoFromCChain(
  ...
  it("test get X Pending Transactions After Nth on running client", async () => {
    const result =
      await cChainMethods.getXPendingTransactionsAfterNthFromCChain(1, 1);
    expect(result.length).toBe(2);
  });
});
...
describe("P-chain", () => {
  it("test get Transaction By Id on running client USES ORTELIUS", async () => {
    const result = await pChainMethods.getTransactionByIdFromPChain(
      "KFYtP5kMYAEWcLmTqyHZsQ9b2sSLpsfwAG74YCZU9eU4bPCdB"
    );
  ...
  it("test get Address Info From on running client", async () => {
    const result = await pChainMethods.getAddressInfoFromPChain(
      "P-fuji1s3yr5cwxsq4xqnktjygdxlxk338063tyuxf8mf"
    );
...
describe("X-chain", () => {
  it("test get Transaction By Id on running client USES ORTELIUS", async () => {
    const result = await xChainMethods.getTransactionByIdFromXChain(
      "2sEjBWSRbPxGbet8qx6BPNUzoKtsA64nHxyV1NEek9Tsj5q6Lv"
    );
  });

  it("test get Address Info on running client", async () => {
    const result = await xChainMethods.getAddressInfoByHashFromXChain(
